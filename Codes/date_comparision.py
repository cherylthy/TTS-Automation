...
# Load both CSV files
ecura_file_path = 'ScraperVerifyReportInternal_2024-09-21_14_40_03.csv'
prive_file_path = '2024-09-16 TTS funds full list by Sherry RAW.csv'
...
result_df['Status as of 21/9/2024'] = result_df.apply(get_status, axis=1)
...
result_df.to_csv('Updated_TTS_FUNDS_Result.csv', index=False)
